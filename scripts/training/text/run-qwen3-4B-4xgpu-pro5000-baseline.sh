...
#
# Qwen3-4B 4xGPU PRO 5000 colocate baseline.
#
# Usage:
...
WANDB_ARGS=(
   ...
   --tb-experiment-name qwen3-4b-GRPO-gpu4-pro5000-baseline-${now}
   # --use-wandb
...
ray job submit ${RAY_NO_WAIT:+--no-wait} --address="http://127.0.0.1:8265" \
   ...
   --colocate \
    ...
    "${EVAL_ARGS[@]}" \
    "${SGLANG_ARGS[@]}" \
    "${MISC_ARGS[@]}"  2>&1 | tee log/qwen3-4b-GRPO-gpu4-pro5000-baseline-${now}.log
